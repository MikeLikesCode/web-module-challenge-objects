...
console.log(createMenuItem('pasta',8,'dinner'))
console.log(createMenuItem('tiramisu',9,'desset'))
...
// console.log(reviews.push({name:"Michael",rating: 2.5,feedback:"Pretty cool tbh."}) && reviews)
